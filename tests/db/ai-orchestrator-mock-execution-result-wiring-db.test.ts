...
test('PostgreSQL preserva i record global canonici PR85 nella catena additiva di 35 migration', { skip: !runDbTests }, async () => {
  ...
  assert.equal(Number(migrations[0]?.count), 35);
