...
| `occurredAt` | `PERSONAL/CONTACT` | profilo N10 v1 ristretto rispetto a RFC 3339: secondi `00`–`59` (leap second esclusi), frazione opzionale di 1–3 cifre, massimo 29 caratteri, input e risultato UTC negli anni `0000`–`9999`, normalizzato ISO millisecondi |
...
- NFC, trim, opzionali vuoti, lowercase email con bound post-folding, spazi telefono, offset temporali, profilo millisecondi senza leap second, confini anno UTC e timestamp impossibili;
