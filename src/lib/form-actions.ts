...
export async function resolveLeadDuplicateCaseAndRefresh(form: FormData) { await resolveLeadDuplicateCaseAction(form); revalidatePath('/leads/duplicates'); revalidatePath('/leads'); revalidatePath('/leads/inbox'); }
