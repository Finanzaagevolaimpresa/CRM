...
async function run(form: FormData, fn: (db: typeof prisma, actor: Awaited<ReturnType<typeof requirePermission>>, raw: unknown) => Promise<{ id?: string; practiceId?: string }>) {
...
export async function confirmPracticeFundingAction(form: FormData) { return run(form, confirmPracticeFunding); }
export async function reversePracticeFundingAction(form: FormData) { return run(form, reversePracticeFunding); }
