...
export const rolePermissions: Record<RoleCode, readonly (Permission | '*')[]> = {
  admin: ['*'],
  direzione: ['technical.read','technical.write','technical.assign','technical.status','technical.admin','practice_communications.read','practice_communications.write','practice_communications.review','practice_communications.mark_used','user.read','settings.manage','lead.read','client.read','company.read','project.read','document.download','document.sensitive.read','ai.execution.request','ai.review','ai_agents.read','ai_agents.write','dossier.read','dossier.write','dossier.approve','legal.read','contract.read','payment.read','audit.read','service.read','service.write','service.assign','service.close'],
