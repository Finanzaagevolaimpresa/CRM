...
const n15Operational = rule('INTERNAL', 'N15_PHASE1A_UNASSIGNED', 'DPO_VALIDATION_REQUIRED');
const n15PersonalReference = rule('PERSONAL', 'N15_PHASE1A_UNASSIGNED', 'DPO_VALIDATION_REQUIRED');
const n15BusinessReference = rule('CONFIDENTIAL', 'N15_PHASE1A_UNASSIGNED', 'DPO_VALIDATION_REQUIRED');
...
export const dataClassificationCatalog = Object.freeze({
  ...
  privacy_evidence_receipt_v1: Object.freeze({
    ...
    businessInboxEventId: privacyEvidence,
  ...
  commercial_lead_inbox_item_v1: Object.freeze({
    id: personalIdentifier,
    leadId: personalIdentifier,
    originKind: operational,
    attributionVersion: operational,
    sourceSystem: operational,
    formCode: operational,
    formVersion: operational,
    sourceOccurredAt: privacyEvidence,
    projectionLedgerId: privacyEvidence,
    privacyEvidenceReceiptId: privacyEvidence,
    state: operational,
    version: operational,
    initializedAt: privacyEvidence,
    closedAt: privacyEvidence,
    retentionClass: operational,
    retentionPolicyVersion: operational,
    retentionEligibleAt: privacyEvidence,
    createdAt: privacyEvidence,
    updatedAt: privacyEvidence,
  }),
  commercial_lead_sla_policy_v1: Object.freeze({
    id: operational,
    policyCode: operational,
    version: operational,
    status: operational,
    calendarCode: operational,
    timezoneCode: operational,
    responseTargetSeconds: operational,
    createdById: personalIdentifier,
    createdAt: operational,
    updatedAt: operational,
  }),
  commercial_lead_sla_cycle_v1: Object.freeze({
    id: personalIdentifier,
    inboxItemId: personalIdentifier,
    sequence: operational,
    policyVersionId: operational,
    availableAt: privacyEvidence,
    dueAt: privacyEvidence,
    firstResponseAt: privacyEvidence,
    closedAt: privacyEvidence,
    outcome: operational,
    version: operational,
    retentionClass: operational,
  ...
  commercial_lead_activity_v1: Object.freeze({
    id: personalIdentifier,
    inboxItemId: personalIdentifier,
    sequence: operational,
    activityType: operational,
    actorKind: operational,
    actorUserId: personalIdentifier,
    actorSessionId: security,
    assigneeBeforeId: personalIdentifier,
    assigneeAfterId: personalIdentifier,
    reasonCode: operational,
    inboxVersionBefore: operational,
    inboxVersionAfter: operational,
    retentionClass: operational,
    retentionPolicyVersion: operational,
    retentionEligibleAt: privacyEvidence,
    createdAt: privacyEvidence,
  }),
  lead_identity_v1: Object.freeze({
    id: personalIdentifier,
    leadId: personalIdentifier,
    identityKeyVersionId: security,
    normalizationVersion: operational,
    keyVersion: operational,
    keyDigest: security,
    status: operational,
    signalKind: operational,
    signalStrength: operational,
    identityDigest: privacyEvidence,
    sourceProjectionId: privacyEvidence,
    sourceDecisionId: privacyEvidence,
    retiredAt: privacyEvidence,
    retiredByDecisionId: privacyEvidence,
    createdById: personalIdentifier,
  ...
  lead_projection_v1: Object.freeze({
    id: personalIdentifier,
    inboxEventId: privacyEvidence,
    sourceRecordHash: privacyEvidence,
    state: operational,
    leadId: personalIdentifier,
    candidateCount: operational,
    normalizationVersion: operational,
    identityKeyVersionId: security,
    version: operational,
    privacyEvidenceCount: operational,
    resultHash: privacyEvidence,
    retentionClass: operational,
    retentionPolicyVersion: operational,
    retentionEligibleAt: privacyEvidence,
    completedAt: privacyEvidence,
    createdAt: privacyEvidence,
    updatedAt: privacyEvidence,
  }),
  lead_duplicate_resolution_v1: Object.freeze({
    caseId: personalIdentifier,
    projectionLedgerId: privacyEvidence,
    state: operational,
    discoveryRevision: operational,
    candidateCount: operational,
    caseVersion: operational,
    leadId: personalIdentifier,
    rank: operational,
    strongestSignal: operational,
    strongSignalCount: operational,
    weakSignalCount: operational,
    matchedSignalCodes: privacyEvidence,
    snapshotHash: privacyEvidence,
    sequence: operational,
    caseVersionBefore: operational,
    outcome: operational,
    selectedLeadId: personalIdentifier,
    resultingLeadId: personalIdentifier,
    actorUserId: personalIdentifier,
    actorSessionId: personalIdentifier,
    reasonCode: operational,
    reasonNote: rule('CONFIDENTIAL', 'CRM_DUPLICATE_RESOLUTION', 'LEGITIMATE_INTEREST'),
    decisionHash: privacyEvidence,
    retentionClass: operational,
    retentionPolicyVersion: operational,
    retentionEligibleAt: privacyEvidence,
    resolvedAt: privacyEvidence,
    createdAt: privacyEvidence,
    updatedAt: privacyEvidence,
  }),
  communication_intent_v1: Object.freeze({
    schemaVersion: n15Operational,
    intentType: n15Operational,
    intentVersion: n15Operational,
    intentId: n15PersonalReference,
    businessCorrelationId: n15PersonalReference,
    occurredAt: n15PrivacyEvidence,
    'source.producerCode': n15Operational,
    'recipient.authorityCode': n15Operational,
    'recipient.entityType': n15Operational,
    'recipient.entityId': n15PersonalReference,
    'message.messageClass': n15Operational,
    'message.reasonCode': n15Operational,
    'message.templateReference.templateCode': n15BusinessReference,
    'message.templateReference.templateVersion': n15BusinessReference,
    'message.templateReference.templateHash': n15PrivacyEvidence,
    'policySnapshot.policyReferenceCode': n15Operational,
    'policySnapshot.policyVersion': n15Operational,
    'policySnapshot.decision': n15Operational,
    'policySnapshot.reasonCode': n15Operational,
    state: n15Operational,
    'idempotency.canonicalizationVersion': n15Operational,
    'idempotency.keyDigest': n15PrivacyEvidence,
    'idempotency.semanticHash': n15PrivacyEvidence,
    'idempotency.envelopeHash': n15PrivacyEvidence,
  }),
  communication_held_decision_v1: Object.freeze({
    schemaVersion: n15Operational,
    decisionType: n15Operational,
    decisionVersion: n15Operational,
    intentId: n15PersonalReference,
    businessCorrelationId: n15PersonalReference,
    intentSemanticHash: n15PrivacyEvidence,
    intentEnvelopeHash: n15PrivacyEvidence,
    evaluatedAt: n15PrivacyEvidence,
    fromState: n15Operational,
    toState: n15Operational,
    'policySnapshot.policyReferenceCode': n15Operational,
    'policySnapshot.policyVersion': n15Operational,
    'policySnapshot.decision': n15Operational,
    'policySnapshot.reasonCode': n15Operational,
    'gateSnapshot.schemaVersion': n15Operational,
    'gateSnapshot.snapshotVersion': n15Operational,
    'gateSnapshot.evaluationModel': n15Operational,
    'gateSnapshot.gates.CAPABILITY': n15Operational,
    'gateSnapshot.gates.WORKER': n15Operational,
    'gateSnapshot.gates.DISPATCH': n15Operational,
    'gateSnapshot.gates.EGRESS': n15Operational,
    'gateSnapshot.gates.CHANNEL': n15Operational,
    'gateSnapshot.gates.PROVIDER': n15Operational,
    'gateSnapshot.gates.TENANT': n15Operational,
    'gateSnapshot.allOfSatisfied': n15Operational,
    'gateSnapshot.decision': n15Operational,
    'gateSnapshot.reasonCode': n15Operational,
    reasonCode: n15Operational,
    decisionHash: n15PrivacyEvidence,
  }),
  communication_audit_record_v1: Object.freeze({
    schemaVersion: n15Operational,
    recordType: n15Operational,
    recordVersion: n15Operational,
    intentReferenceHash: n15PrivacyEvidence,
    correlationReferenceHash: n15PrivacyEvidence,
    sourceReferenceHash: n15PrivacyEvidence,
    recipientReferenceHash: n15PrivacyEvidence,
    templateReferenceHash: n15PrivacyEvidence,
    communicationClassCode: n15Operational,
    intentReasonReferenceHash: n15PrivacyEvidence,
    policyReferenceCode: n15Operational,
    policyReasonCode: n15Operational,
    gateSnapshotHash: n15PrivacyEvidence,
    gateReasonCode: n15Operational,
    fromState: n15Operational,
    toState: n15Operational,
    idempotencyKeyHash: n15PrivacyEvidence,
    semanticHash: n15PrivacyEvidence,
    envelopeHash: n15PrivacyEvidence,
    decisionHash: n15PrivacyEvidence,
  }),
